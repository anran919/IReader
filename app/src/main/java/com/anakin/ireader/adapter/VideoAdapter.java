 ...
 */
public class VideoAdapter extends BaseAdapter<VideoEntity> {
    public VideoAdapter(Context context, List<VideoEntity> datas, int res_id) {
        super(context,datas, res_id);
    }

    @Override
    public BaseHolder<VideoEntity> createHolder(Context context, View view) {
